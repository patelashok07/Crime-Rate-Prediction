<%-- 
    Document   : africa
    Created on : 5 Dec, 2020, 10:44:50 PM
    Author     : dell
--%>
    ...
    <body>
       <div class="container-fluid">
        ...
        <div class="container ext">
            <h2>Africa: Crime Index by Country 2020 Mid-Year</h2><br><hr style="background-color: red"><br>
            <img src="pics/africadata.PNG"><br><hr style="background-color: red"><br>
             <div id="btn">
                  <button type="button" class="btn btn-primary btn-lg region">Select More Region:</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button type="button" class="btn btn-outline-warning btn-lg"><a href="#">AFRICA</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
            <button type="button" class="btn btn-outline-warning btn-lg"><a href="#">AMERICA</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
             <button type="button" class="btn btn-outline-warning btn-lg"><a href="#">ASIA</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
              <button type="button" class="btn btn-outline-warning btn-lg"><a href="#">EUROPE</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
               <button type="button" class="btn btn-outline-warning btn-lg"><a href="#">OCEANIA</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="button" class="btn btn-outline-warning btn-lg"><a href="#">India</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
       </div>
        </div>
