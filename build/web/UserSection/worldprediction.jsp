<%-- 
    Document   : worldprediction
    Created on : 5 Dec, 2020, 1:47:17 PM
    Author     : dell
--%>
...
Crime Report of  World  Mid-Year 2020
</h2>
   ...
   <canvas id="myChart4" width="1400px" height="700px" aria-label="chart" role="img"></canvas><br><hr style="background-color:red"><br><br>
   <!--Select Region-->
   <div id="region">
       <h3 class="text-white">You Also Predict Crime By Selecting Region..</h3>
       <div id="btn">
           <button type="button" class="btn btn-outline-warning btn-lg" width="400px"><a href="region.jsp">SELECT REGION....</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
