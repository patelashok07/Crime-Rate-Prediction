...
<html>
    ...
    <body>
       <div class="container-fluid">
         ...
         <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="../pics/dowry.jpg" alt="First slide" width="100%" height="400">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="../pics/dowry2.jpg" alt="Second slide" width="100%" height="400">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="../pics/dowry3.png" alt="Third slide" width="100%" height="400">
                </div>
            </div>
        ...
        <div class="container">
            <div class="desc">
                <h2 class="text-primary">Crime:Dowry Death In India</h><br><br>
                <h5 class="text-warning">How To Describe Dowry Death:</h5><br>
                <p class="text-white">
                    
                    India. Dowry deaths relate to a bride's suicide or killing committed by her husband and 
                    his family soon after the marriage because of their dissatisfaction with the dowry. ... 
                    This means a bride was burned every 90 minutes, 
                    or dowry issues cause 1.4 deaths per year per 100,000 women in India.<br>
                    In the case of dowry deaths, <strong><em><u>Kerala and Gujarat</u></em></strong> have reported almost a zero rate 
                    while  <strong><em><u>Uttar Pradesh</u></em></strong> has recorded the highest rate of 2.2, twice the national rate. Bihar, Jharkhand, Madhya Pradesh, and Delhi 
                    are among the top ten states in terms of dowry death rate.
                </p>
              
            </div><br><br>
            <div class="desc1">
                <h2 class="text-danger"> State wise crime rate of Dowry Death in 2019</h2>
      ...
      <tr>
       ...
       <tr>
        ...
        <td>0</td>
            ...
            <div class="graph">
                 <canvas id="myChart10" width="1200px" height="800px" aria-label="chart" role="img"></canvas><br><br>
