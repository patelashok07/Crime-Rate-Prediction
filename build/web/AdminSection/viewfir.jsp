    ...
    <body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left:3%">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="adminSection.html">ADD NEW FIR</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="pro.jsp">ADD OFFICER</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">PREDICT RESULT</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="help.html">OFFICER LIST</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="viewfir.jsp"  style="color: black;
            background-color: whitesmoke;text-shadow: hotpink;">VIEW FIR</a>
                </li>
...
throw se;
           ...
           ResultSet rs=st.executeQuery("select name,crime,address,gender,date_crime,city,state,phone from fir");
             out.println("<table border='2' align='centre'>");
             int i=0;
              out.println("<tr id='a'><th>S.No</th><th>Suspect Name</th><th>Crime Name</th><th>Address</th><th>Gender</th><th>Date Crime</th><th>City</th><th>State</th><th>Phone</th></tr>");
           while(rs.next())
           {
...
i++;
               ...
               out.println("<tr id='a'><td>"+i+"</td><td>"+name+"</td><td>"+crime+"</td><td>"+address+"</td><td>"+gender+"</td><td>"+date+"</td><td>"+city+"</td><td>"+state+"</td><td>"+phone+"</td></tr>");
